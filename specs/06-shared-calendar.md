...
- RF-S15. **Color por persona.** En el calendario se pueden superponer varios contactos a la vez (pestañas "Tú · contacto…"). Mientras haya al menos uno superpuesto, todas las actividades se pintan con **el color de su dueño** en lugar del color de su dimensión/tema, para distinguir de un vistazo de quién es cada bloque; con "Tú" a solas vuelve el color coding de temas (spec 05). La paleta (`constants/people-colors.ts`) tiene **veinte colores**, uno por cada color de Nobi y con su mismo identificador: con ocho, a partir del noveno contacto se repetían y dos personas compartían color justo en la vista que existe para distinguirlas. El color de cada contacto se resuelve en este orden: **el que le asigné a mano** desde su ficha, si no **el de su Nobi** —así cada quien sale del color con el que se presenta—, y si ese ya está ocupado, el primero libre. **Mi propio color** se elige igual, desde mi fila en Compartido, y por omisión es el de mi Nobi; volver a tocar el elegido regresa al automático. Mi color queda reservado: no se le reparte a ningún contacto, porque entonces no podría distinguirme de él. Los tonos no son los del PNG del Nobi sino ese matiz llevado a una luminosidad que cumple ≥ 3:1 sobre los dos fondos de la app, porque la apariencia se puede cambiar (NFR-18) y aquí el color lleva significado; por eso «blanco» y «negro» son grises con matiz. El color es una preferencia de quien mira, no del contacto.

**Criterio (RF-S15).** *Dado* que Ana y Pedro comparten su calendario conmigo, *cuando* activo ambas pestañas en la vista mensual, *entonces* mis actividades, las de Ana y las de Pedro se ven cada una en un color distinto y estable; *y cuando* dejo solo "Tú", *entonces* mis actividades vuelven a mostrarse con el color de su tema. *Y dado* que Ana tiene el Nobi verde y nadie más usa ese color, *cuando* la superpongo por primera vez, *entonces* sus actividades salen en verde sin que yo le haya asignado nada.
