...
| | Resultado |
|---|---|
| Pruebas automáticas | **1 530 en verde**, 0 fallidas |
| Cobertura del código | **84.1 %** de sentencias · 85.5 % de líneas |
...
|---|---|---|
| [`pruebas/`](pruebas/) | Las 1 530 pruebas y su cobertura | `pnpm test:coverage` |
...
1 530 pruebas una por una, agrupadas por zona de la aplicación —crear cuenta,
