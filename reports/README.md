...
| | Resultado |
|---|---|
| Pruebas automáticas | **1 560 en verde**, 0 fallidas |
...
|---|---|---|
| [`pruebas/`](pruebas/) | Las 1 560 pruebas y su cobertura | `pnpm test:coverage` |
...
1 560 pruebas una por una, agrupadas por zona de la aplicación —crear cuenta,
